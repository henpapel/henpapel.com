class Regalo extends Cajas{
	...
	checkDatosI(grabar, modificar){
	    ...
	    if( this.revisarPropiedades(alto,"alto") == false ) {
	    	...
	    	$("#alto").addClass('is-invalid');
	    	return false;
	    }
	    
	    if( this.revisarPropiedades(profundidad_cajon,"Profundidad Cajón") == false ) {
	    	
	    	$("#profundidad_cajon").addClass('is-invalid');
	    	return false;
	    }

	    if( this.revisarPropiedades(profundidad_tapa,"Profundidad Tapa") == false ) {
	    	
	    	$("#profundidad_tapa").addClass('is-invalid');
	    	return false;
	    }
	    
	    if( this.revisarPropiedades(grosor_carton,"Grosor Cartón") == false ) {
	    	
	    	$("#grosor_carton").addClass('is-invalid');
	    	return false;
	    }

	    if( this.revisarPropiedades(grosor_tapa,"Grosor Tapa") == false ) {
	    	
	    	$("#grosor_tapa").addClass('is-invalid');
	    	return false;
	    }

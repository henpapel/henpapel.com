...
class Ventas extends Controller {
    ...
    public function listas() {
        ...
        if($login->isLoged()) {
            ...
            require_once 'application/views/templates/head.php';
            require_once 'application/views/templates/top_menu.php';
            require_once 'application/views/ventas/uploads.php';
            require_once 'application/views/templates/footer.php';
    ...
    public function informacion() {
        ...
        if($login->isLoged()) {
            ...
            require_once 'application/views/templates/head.php';
            require_once 'application/views/templates/top_menu.php';
            require_once 'application/views/ventas/info.php';
            require_once 'application/views/templates/footer.php';
        } else {
    ...
    public function archivos() {
        ...
        if($login->isLoged()){
            ...
            require_once 'application/views/templates/head.php';
            require_once 'application/views/templates/top_menu.php';
            require_once 'application/views/ventas/files.php';
            require_once 'application/views/templates/footer.php';
    ...
    public function cambios() {
        ...
        if($login->isLoged()) {
            ...
            require_once 'application/views/templates/head.php';
            require_once 'application/views/templates/top_menu.php';
            require_once 'application/views/ventas/cambios.php';
            require_once 'application/views/templates/footer.php';
        } else {
    ...
    public function uploadFiles() {
        ...
        if($login->isLoged()) {
            ...
            if (empty($_FILES["up-file"]["name"])) {
                ...
                echo '<script language="javascript">';
                echo 'window.location.href="' . URL . 'ventas/archivos/"';
                echo '</script>';
    ...
    public function saveCambio() {
        ...
        if($login->isLoged()) {
            ...
            if (empty($_FILES["up-file"]["name"])) {
                ...
                echo '<script language="javascript">';
                echo 'window.location.href="' . URL . 'ventas/cambios/"';
                echo '</script>';
    ...
    public function uploadList() {
        ...
        if($login->isLoged()) {
            ...
            if (empty($_FILES["up-file"]["name"])) {
                ...
                echo '<script language="javascript">';
                echo 'window.location.href="' . URL . 'ventas/listas/"';
                echo '</script>';
    ...
    require_once 'application/views/templates/head.php';
    require_once 'application/views/templates/top_menu.php';
    require_once 'application/views/ventas/products.php';
    require_once 'application/views/templates/footer.php';
...
if($login->isLoged()){
    ...
    require_once 'application/views/templates/head.php';
    require_once 'application/views/templates/top_menu.php';
    require_once 'application/views/ventas/invitations.php';
    require_once 'application/views/templates/footer.php';
...
if($login->isLoged()){
    ...
    require_once 'application/views/templates/head.php';
    require_once 'application/views/templates/top_menu.php';
    require_once 'application/views/ventas/uploaded_files.php';
    require_once 'application/views/templates/footer.php';
...
if($login->isLoged()){
  $title='Pendientes';
    ...
    require_once 'application/views/templates/head.php';
    require_once 'application/views/templates/top_menu.php';
    require_once 'application/views/ventas/admin_cambios.php';
    require_once 'application/views/templates/footer.php';
...
$response['html']=$table;
    ...
    public function solicitud_facturas(){
        ...
        if($login->isLoged()){
            ...
            require_once 'application/views/templates/head.php';
            require_once 'application/views/templates/top_menu.php';
            require_once 'application/views/facturas/solicitud_facturas.php';
            require_once 'application/views/templates/footer.php';
        }else{
    ...
    public function newFactura(){
        ...
        if($login->isLoged()){
            ...
            require_once 'application/views/templates/head.php';
            require_once 'application/views/templates/top_menu.php';
            require_once 'application/views/facturas/nva_factura.php';
            require_once 'application/views/templates/footer.php';
        }

...
class Controller {
    ...
    public function loadModel($model_name) {
        ...
        /*
        $temp = "";   // esta variable para que se creó, ¿dónde se usa en esta clase???
...
*/
    ...
    protected function calculoDigital($tiraje, $nomb_tam_emp, $corte_ancho_proceso, $corte_largo_proceso, $cortes_por_pliego, $papel_corte_ancho, $papel_corte_largo, $ventas_model) {
        ...
        //$costo_tot_digital = round(floatval($costo_unitario_digital * $tiraje), 2);
...
/**** Inician las funciones de Acabados ****/
    ...
    protected function calculoLaser($tipoGrabado, $tiraje, $Ancho, $Largo, $ventas_model) {
        ...
        $laser_tmp['area']              = round(floatval($Largo * $Ancho), 4);
...
/**** Terminan las funciones de Acabados ****/
    ...
    protected function calculoPerforadoIman($tiraje, $ventas_model) {
        ...
        $perforado_iman['costo_tot']      = $perforado_iman_tot;
    ...
    protected function calculoEncuadernacion($tiraje, $id_papel_exterior_cajon, $enc_cortes_fcaj, $ventas_model) {
        ...
        $arreglo_forrado_cajon_costo_unitario = $forrado_cajon['arreglo_forrado_cajon_costo_unitario'];
        ...
        // perforado iman y puesta
        $perforado_iman = self::calculoPerforadoIman($tiraje, $ventas_model);


        $perforado_iman_costo_unit = round(floatval($perforado_iman['costo_unitario']), 2);

        if ($perforado_iman_costo_unit <= 0) {

            $l_ok = false;
        }

        $perforado_iman_costo_tot = round(floatval($perforado_iman['costo_tot']), 2);


        // despunte esquinas de cajon
        $despunte = self::calculoDespunteEsquinasCajon($tiraje, $ventas_model);


        if ($despunte['costo_unitario_esquinas'] <= 0) {

            $l_ok = false;
        }


        $despunte_costo_unitario = round(floatval($despunte['costo_unitario_esquinas']), 2);
        $despunte_costo_tot = round(floatval($despunte['costo_tot_proceso']), 2);
        ...
        $calculo_tmp['tiraje']                  = $tiraje;
        $calculo_tmp['despunte_costo_unitario'] = $despunte_costo_unitario;
        $calculo_tmp['despunte_costo_tot']      = $despunte_costo_tot;

        $calculo_tmp['arreglo_forrado_cajon_costo_unitario'] = $arreglo_forrado_cajon_costo_unitario;
        $calculo_tmp['arreglo_forrado_cajon_costo']          = $arreglo_forrado_cajon_costo_unitario;

        $calculo_tmp['perf_iman_costo_unitario'] = $perforado_iman_costo_unit;
        $calculo_tmp['perf_iman_costo_tot']      = $perforado_iman_costo_tot;

        $calculo_tmp['forrado_cajon_costo_unitario'] = $forrado_cajon_costo_unitario;
        $calculo_tmp['forrado_cajon_costo']          = $forrado_cajon_costo;

        $calculo_tmp['encajada_costo_unitario']      = $encajada['costo_unitario'];
        $calculo_tmp['encajada_costo_tot']           = $encajada['costo_tot_proceso'];

        $calculo_tmp['costo_tot_proceso'] = ($despunte_costo_tot + $arreglo_forrado_cajon_costo_unitario + $perforado_iman_costo_tot + $forrado_cajon_costo + $encajada['costo_tot_proceso']);
    ...
    protected function calculoEncuadernacion_FCaj($tiraje, $id_papel_exterior_cajon, $enc_cortes_fcaj, $ventas_model) {
        ...
        $costo_tot_proceso = $costo_tot_proceso + $empalme_del_cajon + $enc_costo_unitario;
    ...
    protected function calculoForradoCajon($tiraje, $enc_cortes_fcaj, $id_papel_exterior_cajon, $ventas_model) {
        ...
        $arreglo_forrado_cajon_costo_unitario = 0;

        foreach ($db_tmp as $row) {

            $arreglo_forrado_cajon_costo_unitario = $row['precio_unitario'];
            $arreglo_forrado_cajon_costo_unitario = round(floatval($arreglo_forrado_cajon_costo_unitario), 2);
        }
        ...
        $forrado_cajon_costo_unitario = 0;

        foreach ($db_tmp as $row) {

            $forrado_cajon_costo_unitario = $row['precio_unitario'];
            $forrado_cajon_costo_unitario = round(floatval($forrado_cajon_costo_unitario), 2);
        }
        ...
        $forrado_cajon = round(floatval($forrado_cajon_costo_unitario * $tiraje), 2);
        ...
        $costo_tot_proceso = round(floatval($arreglo_forrado_cajon_costo_unitario + $enc_costo_forrado_cajon + $enc_arreglo_forrado + $enc_costo_empalme_cajon + $enc_encajada_costo_tot), 2);


        $calculo_tmp_Fcaj['tiraje'] = $tiraje;
        $calculo_tmp_Fcaj['arreglo_forrado_cajon_costo_unitario'] = $arreglo_forrado_cajon_costo_unitario;
        $calculo_tmp_Fcaj['arreglo_forrado_cajon']                = round(floatval($arreglo_forrado_cajon_costo_unitario * $tiraje), 2);
        $calculo_tmp_Fcaj['forrado_cajon_costo_unitario']         = round(floatval($forrado_cajon_costo_unitario), 2);
        $calculo_tmp_Fcaj['forrado_cajon']                        = $forrado_cajon;

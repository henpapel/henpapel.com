...
class VentasModel extends Controller {
    ...
    public function costo_proc_caja($proceso) {

        $proceso = trim(strval($proceso));

        $sql = "SELECT * from proc_caja where nombreProceso = '$proceso'";
...
*/
    ...
    public function insertCaja_Almeja_old(&$aJson, $id_modelo) {
        ...
        $base           = intval($aJson['base']);
        $alto           = intval($aJson['alto']);
        $profundidad    = intval($aJson['profundidad']);
        ...
        */
        ...
        // papel empalme
            ...
            if (!$inserted_papel_emp) {
                ...
                $aJson['mensaje'] = "ERROR";
                $aJson['error']   = $aJson['error'] . "; Error al grabar en la tabla cot_alm_papelemp";
            }
        ...
        // Forro del Cajon
            ...
            if (!$inserted_papel_fcaj) {
                ...
                $aJson['mensaje'] = "ERROR";
                $aJson['error']   = $aJson['error'] . "; Error al grabar en la tabla cot_alm_papelfcaj";
            }
        ...
        // Forro de la cartera
            ...
            if (!$inserted_papel_fcar) {
                ...
                $aJson['mensaje'] = "ERROR";
                $aJson['error']   = $aJson['error'] . "; Error al grabar en la tabla cot_alm_papelfcar";
            }
        ...
        // Guarda
            ...
            if (!$inserted_papel_g) {
                ...
                $aJson['mensaje'] = "ERROR";
                $aJson['error']   = $aJson['error'] . "; Error al grabar en la tabla cot_alm_papelguarda";
            }
        ...
        // corte
            ...
            if (!$l_corte_emp) {
                ...
                $aJson['mensaje'] = "ERROR";
                $aJson['error']   = $aJson['error'] . "; Error al grabar en la tabla cot_alm_corte_emp";
            ...
            if (!$l_corte_fcaj) {
                ...
                $aJson['mensaje'] = "ERROR";
                $aJson['error']   = $aJson['error'] . "; Error al grabar en la tabla cot_alm_corte_fcaj";
            ...
            if (!$l_corte_fcar) {
                ...
                $aJson['mensaje'] = "ERROR";
                $aJson['error']   = $aJson['error'] . "; Error al grabar en la tabla cot_alm_corte_fcar";
            ...
            if (!$l_corte_guarda) {
                ...
                $aJson['mensaje'] = "ERROR";
                $aJson['error']   = $aJson['error'] . "; Error al grabar en la tabla cot_alm_corte_guarda";
            ...
            if (!$l_corte_carton_emp) {
                ...
                $aJson['mensaje'] = "ERROR";
                $aJson['error']   = $aJson['error'] . "; Error al grabar en la tabla cot_alm_corte_carton_emp";
            ...
            if (!$l_corte_carton_fcar) {
                ...
                $aJson['mensaje'] = "ERROR";
                $aJson['error']   = $aJson['error'] . "; Error al grabar en la tabla cot_alm_corte_carton_fcar";
        ...
        // Carton Cajon
            ...
            if (!$inserted_papel_caj) {
                ...
                $aJson['mensaje'] = "ERROR";
                $aJson['error']   = $aJson['error'] . "; Error al grabar en la tabla cot_alm_cartoncaj";
            }
        ...
        // Carton Cartera
            ...
            if (!$inserted_papel_car) {
                ...
                $aJson['mensaje'] = "ERROR";
                $aJson['error']   = $aJson['error'] . "; Error al grabar en la tabla cot_alm_cartoncar";
            }
        ...
        // Elab_car
            ...
            if (!$inserted_elab_car) {
                ...
                $aJson['mensaje'] = "ERROR";
                $aJson['error']   = $aJson['error'] . "; Error al grabar en la tabla cot_alm_elab_car";
            }
        ...
        // Elab_guarda
            ...
            if (!$inserted_elab_guarda) {
                ...
                $aJson['mensaje'] = "ERROR";
                $aJson['error']   = $aJson['error'] . "; Error al grabar en la tabla cot_alm_elab_guarda";
            }
        ...
        // Ranurado
            ...
            if (!$inserted_ranurado) {
                ...
                $aJson['mensaje'] = "ERROR";
                $aJson['error']   = $aJson['error'] . "; Error al grabar en la tabla cot_alm_ranurado";
            }
        ...
        // Ranurado_Fcar
            ...
            if (!$inserted_ranurado_fcar) {
                ...
                $aJson['mensaje'] = "ERROR";
                $aJson['error']   = $aJson['error'] . "; Error al grabar en la tabla cot_alm_ranurado_fcar";
            }
        ...
        // Encuadernacion
            ...
            if (!$inserted_encuadernacion) {
                ...
                $aJson['mensaje'] = "ERROR";
                $aJson['error']   = $aJson['error'] . "; Error al grabar en la tabla cot_alm_encuadernacion";
            }
        ...
        // Encuadernacion_Fcaj
            ...
            if (!$inserted_encuadernacion_fcaj) {
                ...
                $aJson['mensaje'] = "ERROR";
                $aJson['error']   = $aJson['error'] . "; Error al grabar en la tabla cot_alm_encuadernacion_fcaj";
            }
                ...
                if ($cuantos_v_OffEmp > 0) {
                    ...
                    for ($k = 0; $k < $cuantos_v_OffEmp; $k++) {
                        ...
                        if (!$l_insert_OffEmp or $costo_tot_proceso <= 0) {
                            ...
                            $aJson['mensaje'] = "ERROR";
                            $aJson['error']   = $aJson['error'] . "; Error al grabar en la tabla cot_alm_offsetemp";
                ...
                if ($cuantos_v_Off_maq_Emp > 0) {
                    ...
                    for ($k = 0; $k < $cuantos_v_Off_maq_Emp; $k++) {
                        ...
                        if (!$l_insert_Off_maq_Emp or $costo_tot_proceso <= 0) {
                            ...
                            $aJson['mensaje'] = "ERROR";
                            $aJson['error']   = $aJson['error'] . "; Error al grabar en la tabla cot_alm_offset_maq_emp";
                ...
                if ($cuantos_v_OffFcaj > 0) {
                    ...
                    for ($k = 0; $k < $cuantos_v_OffFcaj; $k++) {
                        ...
                        if (!$l_insert_OffFcaj or $costo_tot_proceso <= 0) {
                            ...
                            $aJson['mensaje'] = "ERROR";
                            $aJson['error']   = $aJson['error'] . " Error al grabar en la tabla cot_alm_offsetfcaj;";
                ...
                if ($cuantos_v_Off_maq_Fcaj > 0) {
                    ...
                    for ($k = 0; $k < $cuantos_v_Off_maq_Fcaj; $k++) {
                        ...
                        if (!$l_insert_Off_maq_Fcaj or $costo_tot_proceso <= 0) {
                            ...
                            $aJson['mensaje'] = "ERROR";
                            $aJson['error']   = $aJson['error'] . "; Error al grabar en la tabla cot_alm_offset_maq_fcaj";
                ...
                if ($cuantos_v_OffFcar > 0) {
                    ...
                    for ($k = 0; $k < $cuantos_v_OffFcar; $k++) {
                        ...
                        if (!$l_insert_OffFcar or $costo_tot_proceso <= 0) {
                            ...
                            $aJson['mensaje'] = "ERROR";
                            $aJson['error']   = $aJson['error'] . "; Error al grabar en la tabla cot_alm_offsetfcar";
                ...
                if ($cuantos_v_Off_maq_Fcar > 0) {
                    ...
                    for ($k = 0; $k < $cuantos_v_Off_maq_Fcar; $k++) {
                        ...
                        if (!$l_insert_Off_maq_Fcar or $costo_tot_proceso <= 0) {
                            ...
                            $aJson['mensaje'] = "ERROR";
                            $aJson['error']   = $aJson['error'] . "; Error al grabar en la tabla cot_alm_offset_maq_fcar";
                ...
                if ($cuantos_v_OffG) {
                    ...
                    for ($k = 0; $k < $cuantos_v_OffG; $k++) {
                        ...
                        if (!$l_insert_OffG or $costo_tot_proceso <= 0) {
                            ...
                            $aJson['mensaje'] = "ERROR";
                            $aJson['error']   = $aJson['error'] . "; Error al grabar en la tabla cot_alm_offsetguarda";
                ...
                if ($cuantos_v_Off_maq_Fcar > 0) {
                    ...
                    for ($k = 0; $k < $cuantos_v_Off_maq_Fcar; $k++) {
                        ...
                        if (!$l_insert_Off_maq_G or $costo_tot_proceso <= 0) {
                            ...
                            $aJson['mensaje'] = "ERROR";
                            $aJson['error']   = $aJson['error'] . "; Error al grabar en la tabla cot_alm_offset_maq_guarda";
            ...
            if (array_key_exists("DigEmp", $aJson)) {
                ...
                for ($k = 0; $k < $cuantos_v_DigEmp; $k++) {
                    ...
                    if (!$l_insert_DigEmp or $costo_tot_proceso <= 0) {
                        ...
                        $aJson['mensaje'] = "ERROR";
                        $aJson['error']   = $aJson['error'] . "; Error al grabar en la tabla cot_alm_digemp";
            ...
            if (array_key_exists("DigFCaj", $aJson)) {
                ...
                for ($k = 0; $k < $cuantos_v_DigFCaj; $k++) {
                    ...
                    if (!$l_insert_DigFCaj or $costo_tot_proceso <= 0) {
                        ...
                        $aJson['mensaje'] = "ERROR";
                        $aJson['error']   = $aJson['error'] . "; Error al grabar en la tabla cot_alm_digfcaj";
            ...
            if (array_key_exists("DigFCar", $aJson)) {
                ...
                for ($k = 0; $k < $cuantos_v_DigFCar; $k++) {
                    ...
                    if (!$l_insert_DigFCar) {
                        ...
                        $aJson['mensaje'] = "ERROR";
                        $aJson['error']   = $aJson['error'] . "; Error al grabar en la tabla cot_alm_digfcar";
            ...
            if (array_key_exists("DigG", $aJson)) {
                ...
                for ($k = 0; $k < $cuantos_v_DigG; $k++) {
                    ...
                    if (!$l_insert_DigG or $costo_tot_proceso <= 0) {
                        ...
                        $aJson['mensaje'] = "ERROR";
                        $aJson['error']   = $aJson['error'] . "; Error al grabar en la tabla cot_alm_digguarda";
            ...
            if (array_key_exists("SerEmp", $aJson)) {
                ...
                for ($k = 0; $k < $cuantos_v_SerEmp; $k++) {
                    ...
                    if (!$l_insert_SerEmp or $costo_tot_proceso <= 0) {
                        ...
                        $aJson['mensaje'] = "ERROR";
                        $aJson['error']   = $aJson['error'] . "; Error al grabar en la tabla cot_alm_seremp";
            ...
            if (array_key_exists("SerFCaj", $aJson)) {
                ...
                for ($k = 0; $k < $cuantos_v_SerFCaj; $k++) {
                    ...
                    if (!$l_insert_SerFCaj or $costo_tot_proceso <= 0) {
                        ...
                        $aJson['mensaje'] = "ERROR";
                        $aJson['error']   = $aJson['error'] . "; Error al grabar en la tabla cot_alm_serfcaj";
            ...
            if (array_key_exists("SerFCar", $aJson)) {
                ...
                for ($k = 0; $k < $cuantos_v_SerFCar; $k++) {
                    ...
                    if (!$l_insert_SerFCar or $costo_tot_proceso <= 0) {
                        ...
                        $aJson['mensaje'] = "ERROR";
                        $aJson['error']   = $aJson['error'] . "; Error al grabar en la tabla cot_alm_serfcar";
            ...
            if (array_key_exists("SerG", $aJson)) {
                ...
                for ($k = 0; $k < $cuantos_v_SerG; $k++) {
                    ...
                    if (!$l_insert_SerG or $costo_tot_proceso <= 0) {
                        ...
                        $aJson['mensaje'] = "ERROR";
                        $aJson['error']   = $aJson['error'] . "; Error al grabar en la tabla cot_alm_serguarda";
            ...
            if (array_key_exists("Barniz_UV", $aJson)) {
                ...
                for ($k = 0; $k < $cuantos_v_BUVEmp; $k++) {
                    ...
                    if (!$l_insert_BUVEmp or $costo_tot_proceso <= 0) {
                        ...
                        $aJson['mensaje'] = "ERROR";
                        $aJson['error']   = $aJson['error'] . "; Error al grabar en la tabla cot_alm_barnizuvemp";
            ...
            if (array_key_exists("BarnizFcaj", $aJson)) {
                ...
                for ($k = 0; $k < $cuantos_v_BUVFcaj; $k++) {
                    ...
                    if (!$l_insert_BUVFcaj or $costo_tot_proceso <= 0) {
                        ...
                        $aJson['mensaje'] = "ERROR";
                        $aJson['error']   = $aJson['error'] . "; Error al grabar en la tabla cot_alm_barnizuvfcaj";
            ...
            if (array_key_exists("BarnizFcar", $aJson)) {
                ...
                for ($k = 0; $k < $cuantos_v_BUVFcar; $k++) {
                    ...
                    if (!$l_insert_BUVFcar) {
                        ...
                        $aJson['mensaje'] = "ERROR";
                        $aJson['error']   = $aJson['error'] . "; Error al grabar en la tabla cot_alm_barnizuvfcar";
            ...
            if (array_key_exists("BarnizG", $aJson)) {
                ...
                for ($k = 0; $k < $cuantos_v_BUVG; $k++) {
                    ...
                    if (!$l_insert_BUVG or $costo_tot_proceso <= 0) {
                        ...
                        $aJson['mensaje'] = "ERROR";
                        $aJson['error']   = $aJson['error'] . "; Error al grabar en la tabla cot_alm_barnizuvguarda";
            ...
            if (array_key_exists("Laser", $aJson)) {
                ...
                for ($k = 0; $k < $cuantos_v_LaserEmp; $k++) {
                    ...
                    if (!$l_insert_LaserEmp or $costo_tot_proceso <= 0) {
                        ...
                        $aJson['mensaje'] = "ERROR";
                        $aJson['error']   = $aJson['error'] . "; Error al grabar en la tabla cot_alm_laseremp";
            ...
            if (array_key_exists("LaserFcaj", $aJson)) {
                ...
                for ($k = 0; $k < $cuantos_v_LaserFcaj; $k++) {
                    ...
                    if (!$l_insert_LaserFcaj or $costo_tot_proceso <=  0) {
                        ...
                        $aJson['mensaje'] = "ERROR";
                        $aJson['error']   = $aJson['error'] . "; Error al grabar en la tabla cot_alm_laserfcaj";
            ...
            if (array_key_exists("LaserFcar", $aJson)) {
                ...
                for ($k = 0; $k < $cuantos_v_LaserFcar; $k++) {
                    ...
                    if (!$l_insert_LaserFcar or $costo_tot_proceso <= 0) {
                        ...
                        $aJson['mensaje'] = "ERROR";
                        $aJson['error']   = $aJson['error'] . "; Error al grabar en la tabla cot_alm_laserfcar";
            ...
            if (array_key_exists("LaserG", $aJson)) {
                ...
                for ($k = 0; $k < $cuantos_v_LaserG; $k++) {
                    ...
                    if (!$l_insert_LaserG or $costo_tot_proceso <= 0) {
                        ...
                        $aJson['mensaje'] = "ERROR";
                        $aJson['error']   = $aJson['error'] . "; Error al grabar en la tabla cot_alm_laserguarda";
            ...
            if (array_key_exists("Grabado", $aJson)) {
                ...
                for ($k = 0; $k < $cuantos_v_GrabEmp; $k++) {
                    ...
                    if (!$l_insert_GrabEmp or $costo_tot_proceso <= 0) {
                        ...
                        $aJson['mensaje'] = "ERROR";
                        $aJson['error']   = $aJson['error'] . "; Error al grabar en la tabla cot_alm_grabemp";
            ...
            if (array_key_exists("GrabadoFcaj", $aJson)) {
                ...
                for ($k = 0; $k < $cuantos_v_GrabFcaj; $k++) {
                    ...
                    if (!$l_insert_GrabFcaj or $costo_tot_proceso <= 0) {
                        ...
                        $aJson['mensaje'] = "ERROR";
                        $aJson['error']   = $aJson['error'] . "; Error al grabar en la tabla cot_alm_grabfcaj";
            ...
            if (array_key_exists("GrabadoFcar", $aJson)) {
                ...
                for ($k = 0; $k < $cuantos_v_GrabFcar; $k++) {
                    ...
                    if (!$l_insert_GrabFcar or $costo_tot_proceso <= 0) {
                        ...
                        $aJson['mensaje'] = "ERROR";
                        $aJson['error']   = $aJson['error'] . "; Error al grabar en la tabla cot_alm_grabfcar";
            ...
            if (array_key_exists("GrabadoG", $aJson)) {
                ...
                for ($k = 0; $k < $cuantos_v_GrabG; $k++) {
                    ...
                    if (!$l_insert_GrabG or $costo_tot_proceso <= 0) {
                        ...
                        $aJson['mensaje'] = "ERROR";
                        $aJson['error']   = $aJson['error'] . "; Error al grabar en la tabla cot_alm_grabguarda";
            ...
            if (array_key_exists("HotStamping", $aJson)) {
                ...
                for ($k = 0; $k < $cuantos_v_HSEmp; $k++) {
                    ...
                    if (!$l_insert_HSEmp or $costo_tot_proceso <= 0) {
                        ...
                        $aJson['mensaje'] = "ERROR";
                        $aJson['error']   = $aJson['error'] . "; Error al grabar en la tabla cot_alm_hsemp";
            ...
            if (array_key_exists("HotStampingFcaj", $aJson)) {
                ...
                for ($k = 0; $k < $cuantos_v_HSFcaj; $k++) {
                    ...
                    if (!$l_insert_HSFcaj or $costo_tot_proceso <= 0) {
                        ...
                        $aJson['mensaje'] = "ERROR";
                        $aJson['error']   = $aJson['error'] . "; Error al grabar en la tabla cot_alm_hsfcaj";
            ...
            if (array_key_exists("HotStampingFcar", $aJson)) {
                ...
                for ($k = 0; $k < $cuantos_v_HSFcar; $k++) {
                    ...
                    if (!$l_insert_HSFcar or $costo_tot_proceso <= 0) {
                        ...
                        $aJson['mensaje'] = "ERROR";
                        $aJson['error']   = $aJson['error'] . "; Error al grabar en la tabla cot_alm_hsfcar";
            ...
            if (array_key_exists("HotStampingG", $aJson)) {
                ...
                for ($k = 0; $k < $cuantos_v_HSG; $k++) {
                    ...
                    if (!$l_insert_HSG or $costo_tot_proceso <= 0) {
                        ...
                        $aJson['mensaje'] = "ERROR";
                        $aJson['error']   = $aJson['error'] . "; Error al grabar en la tabla cot_alm_hsguarda";
            ...
            if (array_key_exists("Laminado", $aJson)) {
                ...
                for ($k = 0; $k < $cuantos_v_LamEmp; $k++) {
                    ...
                    if (!$l_insert_LamEmp) {
                        ...
                        $aJson['mensaje'] = "ERROR";
                        $aJson['error']   = $aJson['error'] . "; Error al grabar en la tabla cot_alm_lamemp";
            ...
            if (array_key_exists("LaminadoFcaj", $aJson)) {
                ...
                for ($k = 0; $k < $cuantos_v_LamFcaj; $k++) {
                    ...
                    if (!$l_insert_LamFcaj or $costo_tot_proceso <= 0) {
                        ...
                        $aJson['mensaje'] = "ERROR";
                        $aJson['error']   = $aJson['error'] . "; Error al grabar en la tabla cot_alm_lamfcaj";
            ...
            if (array_key_exists("LaminadoFcar", $aJson)) {
                ...
                for ($k = 0; $k < $cuantos_v_LamFcar; $k++) {
                    ...
                    if (!$l_insert_LamFcar or $costo_tot_proceso <= 0) {
                        ...
                        $aJson['mensaje'] = "ERROR";
                        $aJson['error']   = $aJson['error'] . "; Error al grabar en la tabla cot_alm_lamfcar";
            ...
            if (array_key_exists("LaminadoG", $aJson)) {
                ...
                for ($k = 0; $k < $cuantos_v_LamG; $k++) {
                    ...
                    if (!$l_insert_LamG or $costo_tot_proceso <= 0) {
                        ...
                        $aJson['mensaje'] = "ERROR";
                        $aJson['error']   = $aJson['error'] . "; Error al grabar en la tabla cot_alm_lamguarda";
            ...
            if (array_key_exists("Suaje", $aJson)) {
                ...
                for ($k = 0; $k < $cuantos_v_SuaEmp; $k++) {
                    ...
                    if (!$l_insert_SuaEmp or $costo_tot_proceso <= 0) {
                        ...
                        $aJson['mensaje'] = "ERROR";
                        $aJson['error']   = $aJson['error'] . "; Error al grabar en la tabla cot_alm_suajeemp";
            ...
            if (array_key_exists("SuajeFcaj", $aJson)) {
                ...
                for ($k = 0; $k < $cuantos_v_SuaFcaj; $k++) {
                    ...
                    if (!$l_insert_SuaFcaj or $costo_tot_proceso <= 0) {
                        ...
                        $aJson['mensaje'] = "ERROR";
                        $aJson['error']   = $aJson['error'] . "; Error al grabar en la tabla cot_alm_suajefcaj";
            ...
            if (array_key_exists("SuajeFcar", $aJson)) {
                ...
                for ($k = 0; $k < $cuantos_v_SuaFcar; $k++) {
                    ...
                    if (!$l_insert_SuaFcar or $costo_tot_proceso <= 0) {
                        ...
                        $aJson['mensaje'] = "ERROR";
                        $aJson['error']   = $aJson['error'] . "; Error al grabar en la tabla cot_alm_suajefcar";
            ...
            if (array_key_exists("SuajeG", $aJson)) {
                ...
                for ($k = 0; $k < $cuantos_v_SuaG; $k++) {
                    ...
                    if (!$l_insert_SuaG or $costo_tot_proceso <= 0) {
                        ...
                        $aJson['mensaje'] = "ERROR";
                        $aJson['error']   = $aJson['error'] . "; Error al grabar en la tabla cot_alm_suajeguarda";
    ...
    public function getIdClient($nombre_cliente) {

        $nombre = trim($nombre_cliente);
        $nombre = utf8_encode($nombre);


        $sql_name = "SELECT id_cliente FROM clientes where status = 'A' and nombre like '%" . $nombre . "%'";
    ...
    public function getPapel($id, $secc) {
        ...
        switch ($secc) {
            case 'Empalme':
                ...
                $nombre_tabla_tmp = "cot_alm_papelemp";

                break;
            case 'FCajon':

                $nombre_tabla_tmp = "cot_alm_papelfcaj";

                break;
            case 'Fcartera':

                $nombre_tabla_tmp = "cot_alm_papelfcar";

                break;
            case 'Guarda':

                $nombre_tabla_tmp = "cot_alm_papelguarda";

                break;
            case 'bastap':

                $nombre_tabla_tmp = "cot_papel" . $secc;
    ...
    public function getIdCarton($id, $secc) {
        ...
        switch ($secc) {
            case 'Cajon':
                ...
                $nombre_tabla_tmp = "cot_alm_cartoncaj";

                break;
            case 'Cartera':

                $nombre_tabla_tmp = "cot_alm_cartoncar";
                break;
        }
